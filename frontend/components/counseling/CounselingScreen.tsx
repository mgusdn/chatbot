...
const SLOT_EXAMPLES: Record<string, readonly (readonly [string, string])[]> = {
  ...
  thought: [
    ...
    ["자존감 저하", "나는 뭘 해도 부족한 사람이라는 생각이 계속 들어요."],
  ],
  cause: [
