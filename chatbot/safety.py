"""Small deterministic crisis gate for the terminal counselor.

This is not a clinical classifier.  It only keeps obvious high-risk utterances out
of the normal counseling graph and routes them to a fixed response so the model
cannot improvise an emergency answer.
"""
